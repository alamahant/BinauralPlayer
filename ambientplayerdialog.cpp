...
void AmbientPlayerDialog::updateUI()
{
    ...
    m_volumeLabel->setText(QString("%1%").arg(m_player->volume()));
...
QPushButton *AmbientPlayerDialog::stopButton() const
{
    return m_stopButton;
}

QPushButton *AmbientPlayerDialog::playPauseButton() const
{
